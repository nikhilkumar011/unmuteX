...
const Problem = () => {
  return (
    <section id="problem" className="bg-white py-16 px-6 border-y border-zinc-200 transition-all duration-300">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          {/* Card 1 */}
          <div className="border border-zinc-200 bg-white p-8 sm:p-10 hover:border-blue-600/40 hover:shadow-lg transition-all duration-300 rounded-xs">
            <div className="w-12 h-12 bg-blue-600 flex items-center justify-center mb-8 rounded-xs shadow-xs">
        ...
        <div className="mt-12 text-center max-w-2xl mx-auto">
          <p className="text-2xl sm:text-3xl font-bold tracking-tight text-zinc-950 leading-snug">
            You {"don't"} need another boring English grammar tutor.
          </p>

          <p className="text-base text-zinc-600 font-light leading-relaxed mt-4">
