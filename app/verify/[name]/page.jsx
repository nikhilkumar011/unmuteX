...
export default async function Page({ params }) {
    ...
    if (!certificate) {
        return (
            <div className='min-h-screen flex items-center justify-center bg-zinc-50 px-4 transition-colors'>
                <div className='w-full max-w-md text-center bg-white rounded-2xl shadow-sm border border-zinc-200 p-10'>
                    <div className='mx-auto mb-4 h-14 w-14 rounded-full bg-red-50 border border-red-200 flex items-center justify-center'>
    ...
    return (
        <div className='min-h-screen flex items-center justify-center bg-zinc-50 px-4 py-10 transition-colors'>
